...
public class T4uJDBC {
    ...
    public static Connection connect() throws SQLException {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:sqlserver://w2ksa.cs.cityu.edu.hk:1433;databaseName=aiad049_db;", "aiad049", "aiad_049");//no need anymore since JDBC API 4.0
